...
<em>currently 3 different transit options are supported</em>
</p>
...
### Libraries
I found the [Luxon](https://moment.github.io/luxon/#/) Javascript library really helpful for working with time/date values.
...
## Future Improvements
At some point (maybe when it's warmer) I'm planning add a row showing bike availability at the nearest [Citi Bike](https://citibikenyc.com/homepage) station. Citi Bike has a delightful and easy-to-use REST API. Speaking of weather, I'm also planning to add a row that shows the weather and current time.
