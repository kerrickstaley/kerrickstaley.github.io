...
The technique also works pretty well for newspaper articles and TV shows (if you can get a .srt subtitles file).
...
With the exception of genanki, none of these projects is in a very contributor-friendly state. Most of their code isn't very readable or documented, and they could use more unit tests. Still, I'd encourage interested persons to dive in and make contributions; I'll try my best to help you out and make the code more hackable as we go.
