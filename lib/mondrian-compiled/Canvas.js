  ...
  var Canvas = function (_Component) {
    ...
    _createClass(Canvas, [{
      ...
      value: function render() {
        ...
        var widgetsInContainers = this.props.widgets.map(function (widget, index) {
          var containerStyle = {
            position: 'absolute',
            top: _this2.state.widgetPositions[0][index].row,
            left: _this2.state.widgetPositions[0][index].col,
